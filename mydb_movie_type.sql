...
CREATE TABLE `movie_type` (
  ...
  `Timing` int(4) DEFAULT NULL,
  `C_ID` int(11) DEFAULT NULL,
  `Language` varchar(20) DEFAULT NULL,
  `M_Type` varchar(2) DEFAULT NULL,
  KEY `MovieID_idx` (`M_ID`),
  CONSTRAINT `MovieID` FOREIGN KEY (`M_ID`) REFERENCES `movie` (`M_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
